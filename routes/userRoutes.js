...
router.post("/register",body("email").isEmail(),body("password").isLength({min:7,max:50}), registerUser);
...
router.post("/change-password",body("password").isLength({min:7,max:50}),changePasswordUser);
